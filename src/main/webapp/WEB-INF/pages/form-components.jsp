...
<!--[if IE 9 ]><html class="ie9"><![endif]-->
    ...
    <body id="skin-blur-violate">
                ...
                <ul class="list-unstyled side-menu">
                    ...
                    <li class="dropdown active">
                        ...
                        <ul class="list-unstyled menu-item">
                            ...
                            <li><a class="active" href="form_components.do">Form Components</a></li>
        ...
        <script src="assets/js/chosen.min.js"></script> <!-- Custom Multi Select -->
        <script src="assets/js/datetimepicker.min.js"></script> <!-- Date & Time Picker -->
        <script src="assets/js/colorpicker.min.js"></script> <!-- Color Picker -->
        <script src="assets/js/icheck.js"></script> <!-- Custom Checkbox + Radio -->
        <script src="assets/js/autosize.min.js"></script> <!-- Textare autosize -->
        <script src="assets/js/toggler.min.js"></script> <!-- Toggler -->
        <script src="assets/js/input-mask.min.js"></script> <!-- Input Mask -->
        <script src="assets/js/spinner.min.js"></script> <!-- Spinner -->
        <script src="assets/js/slider.min.js"></script> <!-- Input Slider -->
        <script src="assets/js/fileupload.min.js"></script> <!-- File Upload -->
        
        <!-- Text Editor -->
        <script src="assets/js/editor2.min.js"></script> <!-- WYSIWYG Editor -->
        <script src="assets/js/markdown.min.js"></script> <!-- Markdown Editor -->
