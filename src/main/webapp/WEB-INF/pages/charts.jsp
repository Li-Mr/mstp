...
<!--[if IE 9 ]><html class="ie9"><![endif]-->
    ...
    <body id="skin-blur-violate">
                ...
                <ul class="list-unstyled side-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="list-unstyled menu-item">
                            ...
                            <li><a href="profile-page.do">Profile Page</a></li>
        ...
        <script src="assets/js/charts/jquery.flot.orderBar.js"></script> <!-- Flot Bar chart -->
        <script src="assets/js/charts/jquery.flot.pie.min.js"></script> <!-- Flot Pie chart -->
        ...
        <!-- Map -->
        <script src="assets/js/maps/jvectormap.min.js"></script> <!-- jVectorMap main library -->
        <script src="assets/js/maps/usa.js"></script> <!-- USA Map for jVectorMap -->
        <script src="assets/js/maps/world.js"></script> <!-- World Map for jVectorMap -->
